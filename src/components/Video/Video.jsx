...
const Video = ({ src }) => {
  ...
  const sendEmail = () => {
    const subject = "Check This Video";
    const body = `Hi! Click the link below to watch the video:\n\n${base}`;
  ...
  return (
    <>
      <div className="w-full flex flex-col gap-[64px] items-center justify-between py-10 lg:px-[100px] md:px-8 px-[10px]">
        <div className="w-full  flex flex-col lg:flex-row justify-between gap-6 px-2">
          <div className="w-full max-w-[552px] flex flex-col gap-3 md:gap-10">
            <h1 className="font-sora text-[45px] font-bold text-primary">
              Your video is ready!
            </h1>
            <div className="flex flex-col w-full h-[513px] gap-4 md:gap-[64px]">
              <div className="max-w-[385px] h-[61px] flex flex-col justify-between">
                <label
                  htmlFor="title"
              ...
              <div className="w-full h-[68px] flex justify-center items-center gap-0 bg-[rgba(182,179,198,0.20)] px-4 border-[0.5px] border-[#E7E7ED] rounded-2xl">
                ...
                />
                <button
                  className="w-[75px] h-[44px] flex justify-center items-center text-white rounded-lg bg-[#605C84] disabled:cursor-not-allowed"
                  disabled={!email}
                  onClick={sendEmail}
                >
                  Send
              ...
              <div className="flex flex-col justify-between w-full h-[83px] gap-2">
        ...
        <div className="w-full py-12 bg-[rgba(231,231,237,0.20)] flex justify-center items-center">
          <div className="w-full max-w-[747px] flex flex-col justify-center items-center gap-10">
            ...
            <p className="text-[#7E7E7E] font-sora text-lg sm:text-2xl text-center">
      ...
      {!close && (
        <SentModal email={email} closeHandler={setClose} close={close} />
      )}
    </>
  );
};
